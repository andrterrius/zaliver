"""Проверка доступности Gmail (первый шаг пайплайна TikTok)."""
...
# При TikTok mobile-preset весь Playwright-контекст is_mobile=True —
...
def force_desktop_emulation_for_page(page) -> bool:
    ...
    селекторами. На TikTok-вкладку не влияет (CDP target-scoped).
...
def verify_gmail_inbox_available(
    ...
    *,
    ...
    """
    Пайплайн проверки доступности для TikTok (шаг 1):
