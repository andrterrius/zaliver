    ...
    <div className="stack">
      ...
      <div className="grid-2">
        <section className="group stack">
          <h3 className="group-title">Клипы и музыка</h3>
          <label className="hint">Видеоклипы (пути)</label>
          <textarea className="field" value={clips} onChange={(e) => setClips(e.target.value)} />
          <label className="hint">Аудиотреки</label>
          <textarea className="field" value={music} onChange={(e) => setMusic(e.target.value)} />
