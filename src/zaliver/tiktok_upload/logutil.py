"""Логи TikTok-алгоритмов: единый sink + profile id в каждой строке."""
...
def emit_tiktok_log(message: str, *, tag: str = "[tiktok]") -> None:
